...
class ModelConfig:
    ...
    def __init__(self):
        ...
        self.train_file_path = os.path.join(self.dataset_dir, 'balance_train_fold_3.csv')
        self.val_file_path = os.path.join(self.dataset_dir, 'balance_val_fold_3.csv')   
        self.test_file_path = os.path.join(self.dataset_dir, 'balance_val_fold_3.csv')
        self.data_name = 'ESM2_LoRa_balance_fold3'
        # 缓存/日志路径
